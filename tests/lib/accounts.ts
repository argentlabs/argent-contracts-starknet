import { Account, CallData, Contract, ec, encode, hash, RawCalldata } from "starknet";
...
export async function upgradeAccount(accountToUpgrade: Account, argentAccountClassHash: string, calldata: RawCalldata) {
