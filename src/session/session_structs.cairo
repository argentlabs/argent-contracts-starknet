...
const SESSION_TYPE_HASH: felt252 =
    selector!(
        "Session(Session Key:felt,Expires At:felt,Allowed Methods:merkletree,max_fee_usage:felt,token_limits:TokenAmount*,nft_contracts:felt*)TokenAmount(token_address:ContractAddress,amount:u256)u256(low:felt,high:felt)"
    );
