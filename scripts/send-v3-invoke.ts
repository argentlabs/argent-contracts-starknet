import { uint256, num, ec, v3hash, V3TransactionDetails, InvocationsSignerDetails, Call, Calldata, RPC } from "starknet";
import {
  provider, deployer, loadContract
...
const invocationResult = await provider.invokeFunction({ contractAddress: deployer.address, calldata, signature }, v3Details);
