...
CMD ["/usr/local/bin/starknet-devnet", "--host", "0.0.0.0", "--request-body-size-limit", "2500000",  "--seed", "0", "--gas-price", "6000000000", "--data-gas-price", "1", "--timeout", "320", "--lite-mode", "--gas-price-fri", "35000000000000", "--data-gas-price-fri", "1", "--initial-balance", "1000000000000000000000000"]
