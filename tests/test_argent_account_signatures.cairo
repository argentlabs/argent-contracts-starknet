...
use argent::signer::signer_signature::{Signer, StarknetSigner, starknetSignerFromPubKey};
...
fn valid_with_guardian_backup() {
    ...
    let guardian_backup = Option::Some(starknetSignerFromPubKey(guardian_backup_pubkey));
