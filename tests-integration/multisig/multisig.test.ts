...
import { expectEvent, expectExecutionRevert, expectRevertWithErrorMessage, randomStarknetKeyPair, deployMultisig, deployMultisig1_1  } from "../../lib";
...
describe("ArgentMultisig", function () {
  for (const useTxV3 of [false, true]) {
    it(`Should deploy multisig contract (TxV3:${useTxV3})`, async function () {
      ...
      await accountContract.get_version().should.eventually.deep.equal({ major: 0n, minor: 3n, patch: 0n });
