...
mod ArgentAccount {
    ...
    impl UpgradeableCallbackOldImpl of IUpgradableCallbackOld<ContractState> {
        ...
        fn execute_after_upgrade(ref self: ContractState, data: Array<felt252>) -> Array<felt252> {
            ...
            let calls: Array<Call> = full_deserialize_or_error(data.span(), 'argent/invalid-calls');
            ...
            if calls.len() == 1 {
                ...
                if *call.to == account_address {
                    ...
                    if selector == selector!("trigger_escape_owner") {
                        ...
                        full_deserialize_or_error::<Signer>(*call.calldata, 'argent/invalid-calldata');
                    ...
                    if selector == selector!("trigger_escape_guardian") {
                        ...
                        let new_guardian: Option<Signer> = full_deserialize_or_error(
